...
require PROJECT_PATH . '/app/libraries/lithium/core/ObjectDeprecated.php';
require PROJECT_PATH . '/app/libraries/lithium/core/StaticObjectDeprecated.php';
...
require PROJECT_PATH . '/app/libraries/lithium/util/Text.php';
